...
// 缩略图的支持
void CTinyCADDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CTinyCADDoc::InitializeSearchContent()
{
...
void CTinyCADDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
